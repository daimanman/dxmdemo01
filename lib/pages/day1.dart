        ...
        children: <Widget>[
          Container(
            ...
            child: Text(sectionTime,
              style: const TextStyle(fontSize:20.0,fontWeight: FontWeight.w100,color:Color(0xFF555555),fontFamily: 'RobotoMono'),
            ),
          ),
          Container(
  ...
  _onRightBtn(){
    if(!widget.watchOn){
      ...
      setState(() {
        ...
        stopBtnText = '复位';
        underlayColor = Color(0xFFFEEEEE);      
      });
    }
